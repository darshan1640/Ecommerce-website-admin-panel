<header class="main-header" >
  <!-- Logo -->
  <a href="#" class="logo" style="background-color: #051b31;">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini" ><img src="logo1.png" style="width:40px;height:40px;" ></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="logo.png" style="width:190px;height:45px;"></span>
  </a>
  <!-- Header Navbar: style can be found in header.less -->
  <nav class="navbar navbar-static-top" style="background-color: #051b31;" >
